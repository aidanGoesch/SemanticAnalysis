...
function Survey_prolific_IDRoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_prolific_IDComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function informedconsent_1RoutineBegin(snapshot) {
  return async function () {
    ...
    informedconsent_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function informedconsent_2RoutineBegin(snapshot) {
  return async function () {
    ...
    informedconsent_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function informedconsent_3RoutineBegin(snapshot) {
  return async function () {
    ...
    informedconsent_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function informedconsent_4RoutineBegin(snapshot) {
  return async function () {
    ...
    informedconsent_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function informedconsent_5RoutineBegin(snapshot) {
  return async function () {
    ...
    informedconsent_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function verbal_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    verbal_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function narrativeExposureRoutineBegin(snapshot) {
  return async function () {
    ...
    narrativeExposureComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function recall_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    recall_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function verbalRecallRoutineBegin(snapshot) {
  return async function () {
    ...
    verbalRecallComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function next_story_instuctRoutineBegin(snapshot) {
  return async function () {
    ...
    next_story_instuctComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_Likert_Q1RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_Likert_Q1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_Likert_Q2RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_Likert_Q2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_Likert_Q3RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_Likert_Q3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_OpenEnded_Q1RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_OpenEnded_Q1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_OpenEnded_Q2RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_OpenEnded_Q2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_OpenEnded_Q3RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_OpenEnded_Q3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_OpenEnded_Q4RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_OpenEnded_Q4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_OpenEnded_Q5RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_OpenEnded_Q5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Survey_OpenEnded_Q6RoutineBegin(snapshot) {
  return async function () {
    ...
    Survey_OpenEnded_Q6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function debreifRoutineBegin(snapshot) {
  return async function () {
    ...
    debreifComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
