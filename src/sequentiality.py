...
class SequentialityModel:
    ...
    def _to_tokens_and_logprobs(self, text : str) -> list[(str, float)]:
        ...
        :return: list of tuples of strings and their associated log-probability
    ...
    def _calculate_sentence_sequentiality(self, sentence : str, i: int, verbose : bool = False) -> [float]:
        ...
        return [(topic_sequentiality - contextual_sequentiality) / -len(sentence_tokens), contextual_sequentiality, topic_sequentiality]
